...
@TeleOp(name = "HinkleyTeleOpClipSide")
public class HinkleyTeleOpClipSide extends LinearOpMode {
...
//Mechanisms
    ...
    public class Lift{
        ...
        public Action liftuphang(){
            return new HinkleyTeleOpClipSide.Lift.LiftUpHang();
        }
        ...
        public Action liftdownhang(){
            return new HinkleyTeleOpClipSide.Lift.LiftDownHang();
        }
